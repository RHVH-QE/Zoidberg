from common import DELL_PER510_01, DELL_PER515_01, DELL_PER740_28
...
INSTALL_TIER1_TESTCASE_MAP = {
    ...
    'RHEVM-26395': ('ati_fc_01.ks', DELL_PER510_01, 'GeneralCheck.node_check'),
...
INSTALL_TIER2_TESTCASE_MAP = {
    ...
    'RHEVM-26410': ('ati_fc_01.ks', DELL_PER510_01, 'GeneralCheck.layout_init_check'),
    'RHEVM-26398': ('ati_fc_01.ks', DELL_PER510_01, 'GeneralCheck.node_check'),
    'RHEVM-26399': ('ati_fc_02.ks', DELL_PER510_01, 'GeneralCheck.node_check'),
    'RHEVM-26409': ('ati_fc_02.ks', DELL_PER510_01, 'GeneralCheck.iqn_check'),
