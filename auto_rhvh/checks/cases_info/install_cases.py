...
INSTALL_TIER1_TESTCASE_MAP = {
    'RHEVM-23911': ('ati_fc_01.ks', DELL_PER740_28, 'PartitionCheck.partitions_check'),
    'RHEVM-23945': ('ati_fc_01.ks', DELL_PER740_28, 'NetworkCheck.dhcp_network_check'),
    'RHEVM-23950': ('ati_fc_01.ks', DELL_PER740_28, 'NetworkCheck.bond_vlan_check'),
    'RHEVM-26395': ('ati_fc_01.ks', DELL_PER740_28, 'GeneralCheck.node_check'),
...
#    'RHEVM-23948': ('ati_iscsi_01.ks', DELL_PER515_01, 'NetworkCheck.bond_check'),
    ...
    'RHEVM-27167': ('ati_ibm_security_engine.ks', DELL_PER740_28, 'SecurityEngineCheck.security_vdsm_check'),
}

INSTALL_TIER2_TESTCASE_MAP = {
    'RHEVM-23882': ('ati_fc_01.ks', DELL_PER740_28, 'LangCheck.lang_check'),
    'RHEVM-23884': ('ati_fc_01.ks', DELL_PER740_28, 'TimezoneCheck.ntp_check'),
    'RHEVM-23885': ('ati_fc_01.ks', DELL_PER740_28, 'TimezoneCheck.utc_check'),
    'RHEVM-23886': ('ati_fc_01.ks', DELL_PER740_28, 'TimezoneCheck.timezone_check'),
    'RHEVM-23889': ('ati_fc_01.ks', DELL_PER740_28, 'KeyboardCheck.keyboard_check'),
    'RHEVM-23892': ('ati_fc_01.ks', DELL_PER740_28, 'UserCheck.user_check'),
    'RHEVM-23896': ('ati_fc_01.ks', DELL_PER740_28, 'KdumpCheck.kdump_enable_check'),
    'RHEVM-23897': ('ati_fc_01.ks', DELL_PER740_28, 'SelinuxCheck.selinux_check'),
    'RHEVM-23905': ('ati_fc_01.ks', DELL_PER740_28, 'FirewallCheck.firewall_enable_check'),
    'RHEVM-23909': ('ati_fc_01.ks', DELL_PER740_28, 'ServicesCheck.sshd_check'),
    'RHEVM-23954': ('ati_fc_01.ks', DELL_PER740_28, 'NetworkCheck.hostname_check'),
    'RHEVM-26410': ('ati_fc_01.ks', DELL_PER740_28, 'GeneralCheck.layout_init_check'),
    'RHEVM-26398': ('ati_fc_01.ks', DELL_PER740_28, 'GeneralCheck.node_check'),
    'RHEVM-26399': ('ati_fc_02.ks', DELL_PER740_28, 'GeneralCheck.node_check'),
    'RHEVM-26409': ('ati_fc_02.ks', DELL_PER740_28, 'GeneralCheck.iqn_check'),
...
#    'RHEVM-27103': ('ati_iscsi_02.ks', DELL_PER515_01, 'RhsmCheck.subscription_check'),
    ...
    'RHEVM-26400': ('ati_ibm_01.ks', DELL_PER740_28, 'GeneralCheck.node_check'),
    'RHEVM-26958': ('ati_ibm_01.ks', DELL_PER740_28, 'PartitionCheck.partitions_check'),
    'RHEVM-23899': ('ati_ibm_01.ks', DELL_PER740_28, 'SecurityCheck.security_policy_check'),
}
