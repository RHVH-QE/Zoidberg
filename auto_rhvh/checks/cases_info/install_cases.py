...
INSTALL_TIER1_TESTCASE_MAP = {
    ...
    'RHEVM-23938': ('ati_iscsi_01.ks', DELL_PET105_01, 'PartitionCheck.partitions_check'),
    'RHEVM-23942': ('ati_iscsi_01.ks', DELL_PET105_01, 'PartitionCheck.swap_check'),
    'RHEVM-24689': ('ati_iscsi_01.ks', DELL_PET105_01, 'PartitionCheck.partitions_check'),
    'RHEVM-23947': ('ati_iscsi_02.ks', DELL_PER515_01, 'NetworkCheck.vlan_check'),
    'RHEVM-23919': ('ati_local_02.ks', DELL_PER515_01, 'PartitionCheck.partitions_check'),
    'RHEVM-24161': ('ati_local_02.ks', DELL_PER515_01, 'GeneralCheck.node_check'),
}

INSTALL_TIER2_TESTCASE_MAP = {
    'RHEVM-23882': ('ati_local_01.ks', DELL_PET105_01, 'LangCheck.lang_check'),
    'RHEVM-23884': ('ati_local_01.ks', DELL_PET105_01, 'TimezoneCheck.ntp_check'),
    'RHEVM-23885': ('ati_local_01.ks', DELL_PET105_01, 'TimezoneCheck.utc_check'),
    'RHEVM-23886': ('ati_local_01.ks', DELL_PET105_01, 'TimezoneCheck.timezone_check'),
    'RHEVM-23889': ('ati_local_01.ks', DELL_PET105_01, 'KeyboardCheck.keyboard_check'),
    ...
    'RHEVM-23904': ('ati_local_01.ks', DELL_PET105_01, 'FirewallCheck.firewall_check'),
    ...
    'RHEVM-23944': ('ati_local_01.ks', DELL_PET105_01, 'NetworkCheck.static_network_check'),
    'RHEVM-23949': ('ati_local_01.ks', DELL_PET105_01, 'NetworkCheck.nic_stat_dur_install_check'),
    ...
    'RHEVM-23924': ('ati_iscsi_02.ks', DELL_PER515_01, 'PartitionCheck.partitions_check'),
    'RHEVM-23923': ('ati_iscsi_02.ks', DELL_PER515_01, 'PartitionCheck.partitions_check'),
    'RHEVM-23925': ('ati_iscsi_02.ks', DELL_PER515_01, 'PartitionCheck.partitions_check'),
    'RHEVM-23939': ('ati_iscsi_02.ks', DELL_PER515_01, 'PartitionCheck.partitions_check'),
    'RHEVM-23940': ('ati_iscsi_02.ks', DELL_PER515_01, 'PartitionCheck.partitions_check'),
    'RHEVM-23943': ('ati_iscsi_02.ks', DELL_PER515_01, 'PartitionCheck.partitions_check'),
    'RHEVM-24690': ('ati_iscsi_02.ks', DELL_PER515_01, 'PartitionCheck.partitions_check'),
