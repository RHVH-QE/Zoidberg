#
# KS for vdsm vlan over bond anaconda test on dell-per515-01
#
### Language ###
lang en_US.UTF-8
...
network --device=bond0 --bootproto=static --ip=192.168.50.48 --netmask=255.255.255.0 --gateway=192.168.50.1 --bondslaves=p2p1,p2p2 --bondopts=mode=active-backup,primary=p2p1,miimon=100 --vlanid=50
