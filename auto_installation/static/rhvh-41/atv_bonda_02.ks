...
### Network ###
network --device=bond0 --bootproto=static --ip=10.73.73.17 --netmask=255.255.252.0 --gateway=10.73.75.254 --bondslaves=em1,em2 --bondopts=mode=active-backup,primary=em1,miimon=100
