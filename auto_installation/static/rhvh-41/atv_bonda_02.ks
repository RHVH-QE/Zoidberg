...
network --device=bond0 --bootproto=static --ip=10.73.75.55 --netmask=255.255.252.0 --gateway=10.73.75.254 --bondslaves=p3p1,p3p2 --bondopts=mode=active-backup,primary=p3p1,miimon=100
