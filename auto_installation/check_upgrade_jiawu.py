...
class CheckUpgrade(CheckYoo):
    ...
    def _is_bond_net(self, is_bond):
        ...
        if is_bond:
            ...
            if not ret[0] or ("bond" not in ret[1]):
                ...
                return False
            log.info("bond nework works successfully.")
            return True
    ...
    #===========================================
    # check classify - map to constant_upgrade
    #===========================================
    ...
    ## 
    ## Add is_vlan value to set if True, do add 10.0.0.0/8 route
...
if __name__ == '__main__':
    ...
    ck = CheckUpgrade()
    ck.host_string, ck.host_user, ck.host_pass = ('10.73.131.63', 'root',
                                                  'redhat')
                                       
    ck.source_build = 'redhat-virtualization-host-4.1-20170706.0'
    ck.target_build = 'redhat-virtualization-host-4.1-20170927.0'
    ck.beaker_name = DELL_PER515_01
    #ck.beaker_name = DELL_PET105_01

    ck.ksfile = 'atu_yum_update_bond.ks'
